...
export class Client extends ContractClient {
    ...
    constructor(options) {
        super(new ContractSpec(["",
    ...
    fromJSON = {
        ...
        pause_pool: (this.txFromJSON),
        create_pool: (this.txFromJSON),
        next_pool_id: (this.txFromJSON),
        unpause_pool: (this.txFromJSON),
        swap_exact_in: (this.txFromJSON),
        accept_ownership: (this.txFromJSON),
        set_pool_amp_ramp: (this.txFromJSON),
        ...
        set_pool_beneficiary: (this.txFromJSON),
        set_pool_protocol_fee: (this.txFromJSON),
        get_default_protocol_fee: (this.txFromJSON),
        set_default_protocol_fee: (this.txFromJSON),
        get_default_protocol_beneficiary: (this.txFromJSON),
        set_default_protocol_beneficiary: (this.txFromJSON)
    };
}
